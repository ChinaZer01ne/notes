 ...
 *
 * 默认容量是Integer#MAX_VALUE，插入即新增节点
...
public class LinkedBlockingQueue<E> extends AbstractQueue<E>
	 ...
	 * 这也就意味着，同一时刻，只能有一个线程执行入队，其余执行入队的线程将会被阻塞；
	 * 同时，可以有另一个线程执行出队，其余执行出队的线程将会被阻塞。
	 * 换句话说，虽然入队和出队两个操作同时均只能有一个线程操作，
	...
	//容量，如果没有指定，该值默认为Integer.MAX_VALUE;
...
//     }
    ...
    public boolean remove(Object o) {
        ...
        if (o == null) return false;
		 //获取两把锁，删除的时候是不允许入队出队操作的，否则数据就乱了 
        fullyLock();
        try {
